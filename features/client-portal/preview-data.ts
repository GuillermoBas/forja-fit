...
const previewClient: Client = {
  ...
  firstName: "Guillermo",
  lastName: "Bas Portal",
  email: "guillermo.preview@forjafit.local",
  phone: "600123123",
...
const previewPortalAccount: ClientPortalAccountSummary = {
  ...
  email: previewClient.email ?? "cliente.preview@forjafit.local",
  status: "claimed",
    ...
    messages: [
      {
        ...
        role: "assistant",
        content:
          "Soy tu asistente de nutricion de ForjaFit. En preview puedo ayudarte a comprobar el diseno del chat sin llamar al modelo real.",
